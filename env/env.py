...
class SurrogateEnv:
    ...
    def __init__(self, boiler_model:BoilerTimeSeriesModel, chiller_model:ChillerTimeSeriesModel, electrical_model:ElectricalTimeSeriesModel, input_names, output_names):
